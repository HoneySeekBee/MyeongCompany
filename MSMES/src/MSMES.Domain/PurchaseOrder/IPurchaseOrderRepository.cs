...
public interface IPurchaseOrderRepository
{
    ...
    Task<PurchaseOrder?> GetWithItemsAsync(string purchaseOrderNo, CancellationToken ct = default);
    Task<IReadOnlyList<PurchaseOrder>> ListAsync(int skip, int take, CancellationToken ct = default);
    Task<IReadOnlyList<PurchaseOrder>> ListAllAsync(CancellationToken ct = default);
    Task<IReadOnlyList<PurchaseOrderItem>> ListAllItemsAsync(CancellationToken ct = default);
